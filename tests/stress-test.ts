...
const TARGET_URL =
  __ENV.TARGET_URL ??
  "http://localhost:3000/webhooks/shopify/orders/create";
const FIXED_DUPLICATE_ID = 999_999_999;
 ...
 */
function buildPayload(orderId: number): string {
...
export default function (): void {
  ...
  check(res, {
    ...
    "duplicate -> 200 duplicated": (r) =>
      !useDuplicate ||
      (r.status === 200 && (r.body as string).indexOf("duplicated") >= 0),
  });
}
